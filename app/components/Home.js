...
export default class Home extends Component<Props, State> {
  ...
  openInExplorer = (event: any) => {
    ...
    remote.shell.openExternal(
      `https://interface.traaittcash.com/transaction.html?hash=${encodeURIComponent(hash)}`
    );
  };
                              ...
                              <tbody>
                                <tr className="no-hover">
                                  ...
                                  <td>
                                    ...
                                    {tx[5] !== '' ? tx[5] : 'none'}
                                    <br />
                                    {session.atomicToHuman(tx[7], true)} XTCASH
                                    <br />
                                    <p
                                      className={
                                        tx[2] < 0
                                    ...
                                    >
                                      {session.atomicToHuman(tx[2], true)} XTCASH
                                    </p>
                                    <br />
                                    <br />
                                    <button
